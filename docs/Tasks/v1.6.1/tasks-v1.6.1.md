...
| 007 | 預覽端點 effective-permissions(聯集 ∩ 範圍,default-closed,走快取) | pending | ✓ | 002, 003 | `backend/app/services/effective_permission_service.py` / `backend/app/api/v1/api_clients.py` / `backend/app/schemas/client_setting_preview.py` / `backend/tests/test_effective_permissions.py` |
