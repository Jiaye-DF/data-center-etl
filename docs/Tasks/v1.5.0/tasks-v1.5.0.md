...
| 004 | 資料查詢 JSON API + confirmed 英文 key 轉換(A3) | in_progress(worker: claude-E) | ✗ | 003 | `backend/app/api/v1/datasets.py` / `backend/app/services/data_query_service.py` / `backend/app/schemas/data_query.py` / `backend/tests/test_data_query_api.py` |
